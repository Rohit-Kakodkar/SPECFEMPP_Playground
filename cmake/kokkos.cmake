...
# Prepend the CMAKE_MESSAGE_INDENT variable to ensure proper indentation in
# messages
...
if(DEFINED Kokkos_ENABLE_CUDA)
  if(Kokkos_ENABLE_CUDA)
    ...
    set(Kokkos_ENABLE_CUDA_RELOCATABLE_DEVICE_CODE
        ON
        CACHE BOOL "Using CUDA Relocatable device by default")
    set(Kokkos_ENABLE_CUDA_CONSTEXPR
        ON
        CACHE BOOL "Using CUDA Constexpr by default")
  endif()
endif()

# Install Kokkos as a dependency Set Kokkos options before fetching
set(KOKKOS_ENABLE_INSTALL
    OFF
    CACHE BOOL "" FORCE)
...
set(KOKKOS_URL
    "https://github.com/kokkos/kokkos/archive/refs/tags/${KOKKOS_VERSION}.zip")

# For CMake versions < 3.28, EXCLUDE_FROM_ALL is not supported in
...
if(CMAKE_VERSION VERSION_LESS "3.28.0")
  ...
  # For CMake versions >= 3.28, EXCLUDE_FROM_ALL is supported in
  # FetchContent_Declare
else()
  ...
  FetchContent_Declare(
    kokkos
    DOWNLOAD_EXTRACT_TIMESTAMP FALSE
    URL ${KOKKOS_URL} EXCLUDE_FROM_ALL)
